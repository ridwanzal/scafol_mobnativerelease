...
public class KegiatanTree implements Serializable {
    ...
    private ArrayList<Paket> child;

    public KegiatanTree(String keId, String userId, String dinasId, String keJudul, String keNoRekening, String keTahun,
                        String status, String biId, String programId, String dateCreated, String dateUpdated, ArrayList<Paket> child){
        this.keId = keId;
    ...
    public ArrayList<Paket> getChild() {
        return child;
    }

    public void setChild(ArrayList<Paket> child) {
        this.child = child;
    }
