...
public class KegiatanTreeAnggaran implements Serializable {
    ...
    private ArrayList<Anggaran> child;

    public KegiatanTreeAnggaran(String keId, String userId, String dinasId, String keJudul, String keNoRekening, String keTahun,
                                String status, String biId, String programId, String dateCreated, String dateUpdated, ArrayList<Anggaran> child){
        this.keId = keId;
    ...
    public ArrayList<Anggaran> getChild() {
        return child;
    }

    public void setChild(ArrayList<Anggaran> child) {
        this.child = child;
    }
